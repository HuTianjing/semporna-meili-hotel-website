    ...
    >
      <div className="py-20 sm:py-28 md:py-36 lg:py-44">
        <div className="max-w-[1100px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            <span className="font-sans text-[0.6rem] uppercase tracking-[0.35em] text-[#8a7e6b]">01</span>
            <div className="w-8 sm:w-12 h-px bg-[#c4b99a]" />
          ...
          >
            <h2 className="font-serif text-[#1a2a3a] leading-[1.15]">
              ...
              <span
                ...
                style={{ fontSize: 'clamp(1.6rem, 4vw, 3rem)', color: '#6b8f71' }}
              >
                {t('headingLine2')}
              </span>
            </h2>
          ...
          >
            <div className="w-12 sm:w-16 h-px bg-[#c4b99a]" />
          </motion.div>
          ...
          >
            {highlights.map((h) => (
              <div key={h.label} className="flex flex-col items-center text-center">
                ...
                >
                  <h.icon size={16} style={{ color: '#6b8f71' }} strokeWidth={1.5} />
                </div>
