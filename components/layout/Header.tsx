            ...
            <div className="flex items-center gap-7 lg:gap-9">
                ...
                return (
                  <Link
                    ...
                    className={`relative pb-1 font-sans text-[0.75rem] tracking-[0.15em] transition-colors duration-500 after:absolute after:-bottom-0.5 after:left-0 after:h-px after:w-full after:origin-left after:transition-transform after:duration-300 after:content-[''] ${
                      isActive
                        ? isScrolled
                          ? 'font-normal text-[--color-primary] after:scale-x-100 after:bg-[--color-primary]'
                          : 'font-light text-white after:scale-x-100 after:bg-white'
                        : isScrolled
                          ? 'font-normal text-[--color-primary]/80 hover:text-[--color-primary] after:scale-x-0 after:bg-[--color-primary] hover:after:scale-x-100'
              ...
              <div className="relative" ref={langRef}>
                <button
                  ...
                  className={`flex items-center gap-1.5 font-sans text-[0.75rem] tracking-widest transition-colors duration-500 ${isScrolled ? 'font-normal text-[--color-primary]/70 hover:text-[--color-primary]' : 'font-light text-white/80 hover:text-white'}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="14"
